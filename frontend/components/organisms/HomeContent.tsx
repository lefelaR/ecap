  ...
  return (
    <>
      <PageBanner
        ...
        title="Electronic Councillor Action Platform"
        lead="A national municipal reporting system for service delivery issues, anonymous crime reports, authority dashboards, public statistics, and admin management."
        centered
        leadMaxWidth={720}
        titleClass="display-5"
      />
